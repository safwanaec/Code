...
public class MortgageCalculator {
    public static void main(String[] args) {
        ...
        float monthlyInterest = monthlyInterest/1200;
        System.out.print("\nPlease enter time in years: ");
        float time = inp.nextFloat();

        float mortgage = (((float)capital*interest*(float)Math.pow(1+interest,time*12))/((float)Math.pow(1+interest,time*12)-1.0F));
